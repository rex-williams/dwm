...
static const Key keys[] = {
    ...
    /* PROGRAMS */
        ...
        /* MISC */
            /* */
            { MODKEY,                       XK_F2,           spawn,          SHCMD("$(printf \"nicotine\n\" | dmenu -i -l 30)")},
            { MODKEY,                       XK_i,            spawn,          SHCMD("xdotool type \"$(grep -v '^#' \"$HOME\"/.local/share/snippets | dmenu -i -l 50 | cut -d' ' -f1)\"")},
            { MODKEY|ShiftMask,             XK_i,            spawn,          SHCMD("bookmarkthis")},
            /* */
};
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          {.v = (const char*[]){ "dmenu_run", NULL } } },
